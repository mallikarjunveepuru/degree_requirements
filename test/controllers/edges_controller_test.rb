...
class EdgesControllerTest < ActionController::TestCase
  ...
  test "should create edge" do
    assert_difference('Edge.count') do
      post :create, edge: { child_id: @edge.child_id, child_klass: @edge.child_klass, parent_id: @edge.parent_id }
    end
  ...
  test "should update edge" do
    patch :update, id: @edge, edge: { child_id: @edge.child_id, child_klass: @edge.child_klass, parent_id: @edge.parent_id }
    assert_redirected_to edge_path(assigns(:edge))
  end
